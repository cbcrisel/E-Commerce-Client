export class Constants{
    ...
    public static readonly ROUTE_PRODUCTS:string= "products";
    public static readonly ROUTE_CART:string= "cart";
    ...
    public static readonly ACTUAL_ACCESS_TOKEN:string = "actual_access_token";
    public static readonly USER_ID:string = "actual_user";
}